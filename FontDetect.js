var FontDetect = (function(){
	...
	var ctx      = "getContext" in canvas ? canvas.getContext("2d") : undefined;
	...
	function setAllFonts(f){
		if( Array.isArray(f) ) allFonts = f;
	}
